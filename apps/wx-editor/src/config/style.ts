...
export const fontFamilyOptions: IConfigOption[] = [
  {
    label: `系统默认`,
    value: `'mp-quote', -apple-system-font, BlinkMacSystemFont, 'Helvetica Neue', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei UI', 'Microsoft YaHei', Roboto, Arial, sans-serif`,
    desc: `字体123Abc`,
  },
  {
    label: `微软雅黑`,
    value: `'Microsoft YaHei', 'Microsoft YaHei UI', sans-serif`,
    desc: `字体123Abc`,
  },
  {
    label: `苹方字体`,
...
const codeBlockUrlPrefix = `${import.meta.env.BASE_URL}highlightjs/styles/`
